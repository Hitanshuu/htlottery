...
- Last result: 260827: 3-1-1 (AAB)

## Reconciliation
- Record: 1 wins / 62 days resolved

## Model Selection
- UniformBaseline: log-loss=4.7875, top1_hit_rate=1.8809%, n_scored=319
- PerPositionFrequency: log-loss=4.8022, top1_hit_rate=2.5078%, n_scored=319
...
## Tonight's Pick
- Play type: **Any 6** | Target draw: **260828** (2026-08-28) | Stake: AED 5
- Pick: **9-3-8**

## P&L Ledger
- Days played: 63 | Staked: AED 315 | Won: AED 425
- Net P&L: AED 110 | Actual RTP: 134.92% vs theoretical 51.00%
- Expected wins: 0.372 | Actual wins: 1

## Fairness Audit (not a predictor)
- d1: p=0.5476
- d2: p=0.2865
- d3: p=0.5386
- pattern split: p=0.0929
